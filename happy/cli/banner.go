...
import (
	...
	"github.com/mkungla/happy/cli/color"
)
...
func Banner(s happy.Session) {
	b := &banner{}
	b.Defaults()
	b.Vars.Title = s.Get("app.title").String()
	b.Vars.CopyrightBy = s.Get("app.copyright.by").String()
	b.Vars.CopyrightSince = s.Get("app.copyright.since").Int()
	b.Vars.License = s.Get("app.license").String()
	b.Vars.Version = s.Get("app.version").String()
	b.Vars.Description = s.Get("app.description").String()
	b.Print()
}
...
func (b *banner) Print() error {
	...
	b.buffer.Write(col)
	err := b.ParseTmpl("header-tmpl", b.Vars, 0)
	if err != nil {
