...
func Float64(name string, value float64, usage string, aliases ...string) (flag *Float64Flag, err error) {
	...
	flag.usage = usage
	flag.defval, err = vars.Float64(name, value, true)
	if err != nil {
		return nil, err
	}
	flag.variable, err = vars.Float64(name, value, false)
	return flag, err
}

func Float64Func(name string, value float64, usage string, aliases ...string) CreateFlagFunc {
