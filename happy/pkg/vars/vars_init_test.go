...
var complex64Tests = []complex64Test{
	...
	{"COMPLEX64_2", "1", "(0+0i)", complex64(0), strconv.ErrSyntax},
	{"COMPLEX64_3", "1.000000059604644775390626 2", "1.0000001 2", complex(1.0000001, 2), nil},
	{"COMPLEX64_4", "1x -0", "(0+0i)", complex64(0), strconv.ErrSyntax},
	{"COMPLEX64_5", "-0 1x", "(0+0i)", complex64(0), strconv.ErrSyntax},
}

var complex128Tests = []complex128Test{
	{"COMPLEX128_1", " 1", "(0+0i)", complex128(0), strconv.ErrSyntax},
	{"COMPLEX128_2", "+1 -1", "1 -1", complex128(complex(1, -1)), nil},
	{"COMPLEX128_3", "1x -0", "(0+0i)", complex128(0), strconv.ErrSyntax},
	{"COMPLEX128_3", "-0 1x", "(0+0i)", complex128(0), strconv.ErrSyntax},
	{"COMPLEX128_4", "1.1. 0", "(0+0i)", complex128(0), strconv.ErrSyntax},
