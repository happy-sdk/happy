...
type MapIface[VAR VariableIface[VAL], VAL ValueIface] interface {
	...
	// All() []VAR
	// ToBytes() []byte
	// ToKeyValSlice() []string
	// ExtractWithPrefix(prfx string) MapIface[VAR, VAL]
	// LoadWithPrefix(prfx string) (MapIface[VAR, VAL], bool)
}
...
func (m GenericMap[MAP, VAR, VAL]) Len() int {
	return m.m.Len()
}

func (m GenericMap[MAP, VAR, VAL]) Has(key string) bool {
	return m.m.Has(key)
}

// func (m GenericMap[MAP, VAR, VAL]) Delete(key string) {
// 	m.m.Delete(key)
// }

// func (m GenericMap[MAP, VAR, VAL]) StoreReadOnly(key string, value any, ro bool) error {
// 	return m.m.StoreReadOnly(key, value, ro)
// }

// func (m GenericMap[MAP, VAR, VAL]) Store(key string, value any) error {
// 	return m.m.Store(key, value)
// }

func (m GenericMap[MAP, VAR, VAL]) Get(key string) VAR {
	return m.m.Get(key)
}

// func (m GenericMap[MAP, VAR, VAL]) LoadWithPrefix(prfx string) (set MAP, loaded bool) {
// 	rm, ok := m.m.LoadWithPrefix(prfx)
// 	loaded = ok
// 	return AsMap[MAP, VAR, VAL](rm), loaded
// }

// func (m GenericMap[MAP, VAR, VAL]) ExtractWithPrefix(prfx string) MAP {
// 	rm := m.m.ExtractWithPrefix(prfx)
// 	return AsMap[MAP, VAR, VAL](rm)
// }

// func (m GenericMap[MAP, VAR, VAL]) Load(key string) (v VAR, ok bool) {
// 	mm, ok := m.m.Load(key)
// 	return AsVariable[VAR, VAL](mm), ok
// }

// func (m GenericMap[MAP, VAR, VAL]) LoadAndDelete(key string) (v VAR, loaded bool) {
// 	mm, ok := m.m.LoadAndDelete(key)
// 	return AsVariable[VAR, VAL](mm), ok
// }

// func (m GenericMap[MAP, VAR, VAL]) LoadOrDefault(key string, value any) (v VAR, loaded bool) {
// 	mm, ok := m.m.LoadOrDefault(key, value)
// 	return AsVariable[VAR, VAL](mm), ok
// }

// func (m GenericMap[MAP, VAR, VAL]) LoadOrStore(key string, value any) (actual VAR, loaded bool) {
// 	mm, ok := m.m.LoadOrStore(key, value)
// 	return AsVariable[VAR, VAL](mm), ok
// }

// func (m GenericMap[MAP, VAR, VAL]) Range(f func(v VAR) bool) {
...
// func (m GenericMap[MAP, VAR, VAL]) All() (all []VAR) {
// 	m.m.Range(func(orig Variable) bool {
// 		v := AsVariable[VAR, VAL](orig)
// 		all = append(all, v)
// 		return true
...
// func (m GenericMap[MAP, VAR, VAL]) ToBytes() []byte {
// 	return m.m.ToBytes()
// }

// func (m GenericMap[MAP, VAR, VAL]) ToKeyValSlice() []string {
// 	return m.m.ToKeyValSlice()
// }
